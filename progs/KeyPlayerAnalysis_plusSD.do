...
save KeyPlayerplusSD, replace

use KeyPlayerplusSD, clear
...
keep name Delta_RD 
export excel using ../results/KeyPlayer_result_plusSD.xls, replace first(varl)
