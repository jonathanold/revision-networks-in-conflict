...
*------------------------
* Replicate Table 1, with asinh
*------------------------

use KRTZ_monadic_AF.dta, clear

foreach v of varlist TotFight TotFight_Enemy TotFight_Allied TotFight_Neutral {
        replace `v' = asinh(`v')
 }
...
using "../replication_outputs/tables/table_1_asinh.tex" , style(tex) 
eqlabels(" " " ") 
wrap varwidth(45) 
...
*------------------------
* Replicate Table 1, with log(X+1)
*------------------------
...
estout 
t1_c1 t1_c2 t1_c3 t1_c4  t1_c5 t1_c6  t1_c7 t1_c8
using "../replication_outputs/tables/table_1_log.tex" , style(tex) 
eqlabels(" " " ") 
wrap varwidth(45) 
varlabels(TotFight_Enemy "Enemies (TFE)" TotFight_Allied "Allies (TFA)" TotFight_Neutral "Neutral (TFN)")
keep(TotFight_Enemy TotFight_Allied TotFight_Neutral)
