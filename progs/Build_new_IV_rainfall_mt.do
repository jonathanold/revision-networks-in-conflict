...
* collapse (sum) dmin_enemies Gov_enemies rain_enemies, by(group year)
$aggregation dmin_allies Gov_allies rain_allies*, by(group year)
rename rain_allies0 rain_allies_of_enemies0
rename rain_allies1 rain_allies_of_enemies1
rename rain_allies2 rain_allies_of_enemies2
rename rain_allies3 rain_allies_of_enemies3
rename dmin_allies dmin_allies_of_enemies
rename Gov_allies Gov_allies_of_enemies
sort group year
save tempG, replace
...
* collapse (sum) dmin_enemies Gov_enemies rain_enemies, by(group year)
$aggregation dmin_allies Gov_allies rain_allies*, by(group year)
rename rain_allies0 rain_allies_of_neutrals0
rename rain_allies1 rain_allies_of_neutrals1
rename rain_allies2 rain_allies_of_neutrals2
rename rain_allies3 rain_allies_of_neutrals3
rename dmin_allies dmin_allies_of_neutrals
rename Gov_allies Gov_allies_of_neutrals
sort group year
save tempH, replace


**
* Enemies of Neutrals //NEW
**
...
* collapse (sum) dmin_enemies Gov_enemies rain_enemies, by(group year)
$aggregation dmin_enemies Gov_enemies rain_enemies*, by(group year)
rename rain_enemies0 rain_enemies_of_neutrals0
rename rain_enemies1 rain_enemies_of_neutrals1
rename rain_enemies2 rain_enemies_of_neutrals2
rename rain_enemies3 rain_enemies_of_neutrals3
rename dmin_enemies dmin_enemies_of_neutrals
rename Gov_enemies Gov_enemies_of_neutrals
sort group year
save tempI, replace
...
replace dmin_enemies=0 if dmin_enemies==.
replace rain_enemies0=0 if rain_enemies0==.
replace rain_enemies1=0 if rain_enemies1==.
replace rain_enemies2=0 if rain_enemies2==.
replace rain_enemies3=0 if rain_enemies3==.
replace Gov_enemies=0 if Gov_enemies==.
replace dmin_enemies_enemies=0 if dmin_enemies_enemies==.
replace rain_enemies_enemies0=0 if rain_enemies_enemies0==.
replace rain_enemies_enemies1=0 if rain_enemies_enemies1==.
replace rain_enemies_enemies2=0 if rain_enemies_enemies2==.
replace rain_enemies_enemies3=0 if rain_enemies_enemies3==.
replace Gov_enemies_enemies=0 if Gov_enemies_enemies==.
...
drop _merge
sort group year 
merge group year using tempG
tab _merge
replace dmin_allies_of_enemies=0 if _merge==1
replace rain_allies_of_enemies0=0 if _merge==1
replace rain_allies_of_enemies1=0 if _merge==1
replace rain_allies_of_enemies2=0 if _merge==1
replace rain_allies_of_enemies3=0 if _merge==1
replace Gov_allies_of_enemies=0 if _merge==1
replace dmin_allies_of_enemies=0 if dmin_allies_of_enemies==.
replace rain_allies_of_enemies0=0 if rain_allies_of_enemies0==.
replace rain_allies_of_enemies1=0 if rain_allies_of_enemies1==.
replace rain_allies_of_enemies2=0 if rain_allies_of_enemies2==.
replace rain_allies_of_enemies3=0 if rain_allies_of_enemies3==.
replace Gov_allies_of_enemies=0 if Gov_allies_of_enemies==.
drop _merge
sort group year 
merge group year using tempH
tab _merge
replace dmin_allies_of_neutrals=0 if _merge==1
replace rain_allies_of_neutrals0=0 if _merge==1
replace rain_allies_of_neutrals1=0 if _merge==1
replace rain_allies_of_neutrals2=0 if _merge==1
replace rain_allies_of_neutrals3=0 if _merge==1
replace Gov_allies_of_neutrals=0 if _merge==1
replace dmin_allies_of_neutrals=0 if dmin_allies_of_neutrals==.
replace rain_allies_of_neutrals0=0 if rain_allies_of_neutrals0==.
replace rain_allies_of_neutrals1=0 if rain_allies_of_neutrals1==.
replace rain_allies_of_neutrals2=0 if rain_allies_of_neutrals2==.
replace rain_allies_of_neutrals3=0 if rain_allies_of_neutrals3==.
replace Gov_allies_of_neutrals=0 if Gov_allies_of_neutrals==.
drop _merge
sort group year 
merge group year using tempI
tab _merge
replace dmin_enemies_of_neutrals=0 if _merge==1
replace rain_enemies_of_neutrals0=0 if _merge==1
replace rain_enemies_of_neutrals1=0 if _merge==1
replace rain_enemies_of_neutrals2=0 if _merge==1
replace rain_enemies_of_neutrals3=0 if _merge==1
replace Gov_enemies_of_neutrals=0 if _merge==1
replace dmin_enemies_of_neutrals=0 if dmin_enemies_of_neutrals==.
replace rain_enemies_of_neutrals0=0 if rain_enemies_of_neutrals0==.
replace rain_enemies_of_neutrals1=0 if rain_enemies_of_neutrals1==.
replace rain_enemies_of_neutrals2=0 if rain_enemies_of_neutrals2==.
replace rain_enemies_of_neutrals3=0 if rain_enemies_of_neutrals3==.
replace Gov_enemies_of_neutrals=0 if Gov_enemies_of_neutrals==.
drop _merge
sort group year
